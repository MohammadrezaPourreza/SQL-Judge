"""This file contains the class for representing database schemas."""
...
class ColumnInfo:
  ...
  foreign_keys: List[Tuple[str, str]] = dataclasses.field(default_factory=list)
  referenced_by: List[Tuple[str, str]] = dataclasses.field(default_factory=list)
  unique_values: List[str] = dataclasses.field(default_factory=list)
  value_statics: str = ""
...
class DatabaseSchema:
  ...
  tables: Dict[str, TableSchema] = dataclasses.field(default_factory=dict)
  ...
  def add_info_from_schema(
    ...
    """Adds field information from another schema to the current schema.
